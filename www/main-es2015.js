...
/* harmony default export */ __webpack_exports__["default"] = ("<ion-tabs></ion-tabs>\r\n");
...
const routes = [
    ...
    {
        path: 'social',
        loadChildren: () => Promise.all(/*! import() | pages-social-social-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-social-social-module")]).then(__webpack_require__.bind(null, /*! ./pages/social/social.module */ "./src/app/pages/social/social.module.ts")).then(m => m.SocialPageModule)
    },
    {
        path: 'map',
        loadChildren: () => Promise.all(/*! import() | pages-map-map-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-map-map-module")]).then(__webpack_require__.bind(null, /*! ./pages/map/map.module */ "./src/app/pages/map/map.module.ts")).then(m => m.MapPageModule)
    },
    {
        path: 'cgu',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-cgu-cgu-module */ "pages-cgu-cgu-module").then(__webpack_require__.bind(null, /*! ./pages/cgu/cgu.module */ "./src/app/pages/cgu/cgu.module.ts")).then(m => m.CGUPageModule)
    },
    {
        path: 'register',
    ...
    {
        path: 'forgetpassword',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-forgetpassword-forgetpassword-module */ "pages-forgetpassword-forgetpassword-module").then(__webpack_require__.bind(null, /*! ./pages/forgetpassword/forgetpassword.module */ "./src/app/pages/forgetpassword/forgetpassword.module.ts")).then(m => m.ForgetpasswordPageModule)
    },
    {
        path: 'datepicker',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-datepicker-datepicker-module */ "pages-datepicker-datepicker-module").then(__webpack_require__.bind(null, /*! ./pages/datepicker/datepicker.module */ "./src/app/pages/datepicker/datepicker.module.ts")).then(m => m.DatepickerPageModule)
    }
];
...
/* harmony import */ var _services_languageService_language_service_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/languageService/language-service.service */ "./src/app/services/languageService/language-service.service.ts");
...
let AppComponent = class AppComponent {
    constructor(router, afAuth, platform, splashScreen, statusBar, languageService) {
        this.router = router;
        this.afAuth = afAuth;
...
AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"],
        ...
        _services_languageService_language_service_service__WEBPACK_IMPORTED_MODULE_7__["LanguageServiceService"]])
], AppComponent);
...
/* harmony import */ var _ionic_native_date_picker_ngx__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @ionic-native/date-picker/ngx */ "./node_modules/@ionic-native/date-picker/ngx/index.js");
...
/* harmony import */ var _services_firebaseService_firebase_service_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./services/firebaseService/firebase-service.service */ "./src/app/services/firebaseService/firebase-service.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _services_firebaseService_firebase_service_service__WEBPACK_IMPORTED_MODULE_21__["FirebaseService"],
            _ionic_native_file_path_ngx__WEBPACK_IMPORTED_MODULE_6__["FilePath"],
            _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_5__["Geolocation"],
            _ionic_native_date_picker_ngx__WEBPACK_IMPORTED_MODULE_19__["DatePicker"],
...
let FirebaseService = class FirebaseService {
    constructor(afAuth, afDB, afSG, loadingController, alertController) {
        this.afAuth = afAuth;
        this.afDB = afDB;
        this.afSG = afSG;
    ...
    getImagesStorage(image, images, key) {
    ...
    createKey(docName) {
        return new Promise((resolve) => {
            const newPostKey = firebase_app__WEBPACK_IMPORTED_MODULE_5__["database"]().ref().child(docName).push().key; // création de la clé dans la database
            resolve(newPostKey);
        });
    }
    addData(path, data) {
    ...
    getImagesUserDatabase(folder, uid, images) {
        firebase_app__WEBPACK_IMPORTED_MODULE_5__["database"]().ref(folder + '/' + uid).once('value')
            .then((snapshot) => {
...
LanguageServiceService.ctorParameters = () => [
    { type: _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__["TranslateService"] },
    { type: _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"] }
];
LanguageServiceService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
module.exports = __webpack_require__(/*! C:\Users\AGARAULT\Desktop\contest2\WorldVisit\src\main.ts */"./src/main.ts");
